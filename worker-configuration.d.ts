/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: 0ee13d34ad63df30ec34794d27450a88)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LOG_LEVEL: string;
		REPO_DO: DurableObjectNamespace /* RepoDurableObject from git-on-cloudflare/src/do */;
		AUTH_DO: DurableObjectNamespace /* AuthDurableObject from git-on-cloudflare/src/do */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPO_DO_IDLE_MINUTES" | "REPO_DO_MAINT_MINUTES" | "REPO_KEEP_PACKS" | "REPO_PACKLIST_MAX" | "REPO_UNPACK_CHUNK_SIZE" | "REPO_UNPACK_MAX_MS" | "REPO_UNPACK_DELAY_MS" | "REPO_UNPACK_BACKOFF_MS" | "LOG_LEVEL">> {}
}
declare module "*.sql" {
	const value: string;
